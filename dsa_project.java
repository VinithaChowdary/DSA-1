...
public class dsa_project {
    ...
    public static void main(String[] args) {
        ...
        int choice;
        System.out.println();
        System.out.println("    ~~~~Welcome to Amrita Delux Hotel~~~~");
        System.out.println();
        do {
            System.out.println("--------------------------------------");
    ...
    private static void placeFoodOrder() {
        ...
        if (foundGuest != null) {
            ...
            System.out.println("1. Pizza - 1000.0/-");
            System.out.println("2. Burger - 350.0/-");
            System.out.println("3. Salad - 720.0/-");
            System.out.println("4. Pasta - 864.0/-");
            System.out.println("5. Sandwich - 694.0/-");
            ...
            while (!done) {
                ...
                switch (foodChoice) {
                    case 1:
                        foundGuest.addFoodItem("Pizza", 100.0);
                        System.out.println("Pizza added to the order.");
                        break;
                    case 2:
                        foundGuest.addFoodItem("Burger", 350.0);
                        System.out.println("Burger added to the order.");
                        break;
                    case 3:
                        foundGuest.addFoodItem("Salad", 720.0);
                        System.out.println("Salad added to the order.");
                        break;
                    case 4:
                        foundGuest.addFoodItem("Pasta", 864.0);
                        System.out.println("Pasta added to the order.");
                        break;
                    case 5:
                        foundGuest.addFoodItem("Sandwich", 694.0);
